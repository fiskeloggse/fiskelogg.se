  ...
  return (
    ...
    >
      <summary className="flex cursor-pointer list-none items-start justify-between gap-3">
        ...
        {/* Only shown once the card is already open -- editing the name/
            dates needs the content area visible anyway, so there's nothing
            to reach for while the card is still collapsed. A <button>
            inside <summary> would otherwise swallow the click before it
            reaches summary's own toggle behavior regardless. */}
        {cardOpen && (
          <button
            type="button"
